...
\begin{figure}
\subfloat[Offset distribution\label{fig::qc1}]{\includegraphics[width=0.5\textwidth]{latex/fig2_crop.pdf}}
\subfloat[Disproportion test\label{fig::qc2}]{\includegraphics[width=0.5\textwidth]{latex/fig3_crop.pdf}}
\end{figure}
