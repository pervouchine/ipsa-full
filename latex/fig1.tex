...
\path[line] let \p1=(bam.south), \p2=(ssj6.north) in (bam.south) --  +(0,0.5*\y2-0.5*\y1) node[below] {\prog{count with offsets}} -| node [pos=0.3, above] {Splice Junctions} (ssj6.north);
